...
extension DeveloperToolsSupport.ImageResource {
    ...
    static let background = DeveloperToolsSupport.ImageResource(name: "background_image", bundle: resourceBundle)

    /// The "envelope" asset catalog image resource.
    static let envelope = DeveloperToolsSupport.ImageResource(name: "envelope", bundle: resourceBundle)
...
extension AppKit.NSImage {
    ...
    /// The "background_image" asset catalog image.
    ...
    /// The "envelope" asset catalog image.
    static var envelope: AppKit.NSImage {
#if !targetEnvironment(macCatalyst)
        .init(resource: .envelope)
#else
        .init()
#endif
    }
...
extension UIKit.UIImage {
    ...
    /// The "envelope" asset catalog image.
    static var envelope: UIKit.UIImage {
#if !os(watchOS)
        .init(resource: .envelope)
#else
        .init()
